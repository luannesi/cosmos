# ORDER — Orchestrated Runtime for Distributed Execution & Reasoning — Especificação Completa v2.3

**Status:** Especificação de referência para implementação
**Versão:** 2.3 (supersede v2.2)
**Data:** 2026-09-18
**Documentos irmãos:** CHAOS v2.3 · Implementação Claude-Nativa v1.1
...
**Assistente Pessoal é obrigatório** (`agent.fn.assistant`) e sempre materializado em Fase 0. A Implementação Claude-Nativa v1.1 define o gerador e o Onboarding Protocol.
...
## 45. Definition of Done — ORDER v2.3
